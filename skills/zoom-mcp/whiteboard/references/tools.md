...
|------|---------|----------------|
| `add_a_whiteboard_collaborator` | Add collaborators to a whiteboard | Requires collaborator-write scope |
...
| `get_a_whiteboard_collaborator` | List a whiteboard's collaborators | Requires collaborator-read scope |
...
| `update_a_whiteboard_collaborator` | Update whiteboard collaborators | Requires collaborator-update scope |
| `delete_a_whiteboard_collaborator` | Remove a collaborator from a whiteboard | Requires collaborator-delete scope |
